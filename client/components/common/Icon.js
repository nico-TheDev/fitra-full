...
const Icon = ({ name, size = 40, color }) => {
    if (name === ICON_NAMES.ACCOUNT)
        return <AccountIcon color={color} size={size} />;
    if (name === ICON_NAMES.ADD) return <AddIcon color={color} size={size} />;
    if (name === ICON_NAMES.ADD_PHOTO_V1)
        return <AddPhotoV1Icon color={color} size={size} />;
    if (name === ICON_NAMES.ADD_PHOTO_V2)
        return <AddPhotoV2Icon color={color} size={size} />;
    ...
    if (name === ICON_NAMES.CALCULATOR)
        return <CalculatorIcon color={color} size={size} />;
    if (name === ICON_NAMES.CALENDAR)
        return <CalendarIcon color={color} size={size} />;
    if (name === ICON_NAMES.CAR) return <CarIcon color={color} size={size} />;
    if (name === ICON_NAMES.CATEGORIES)
        return <CategoriesIcon color={color} size={size} />;
    if (name === ICON_NAMES.CHARTS)
        return <ChartsIcon color={color} size={size} />;
    if (name === ICON_NAMES.DASHBOARD)
        return <DashboardIcon color={color} size={size} />;
    if (name === ICON_NAMES.DROPDOWN)
        return <DropdownIcon color={color} size={size} />;
    if (name === ICON_NAMES.EDIT) return <EditIcon color={color} size={size} />;
    if (name === ICON_NAMES.EDUCATION)
        return <EducationIcon color={color} size={size} />;
    if (name === ICON_NAMES.ENERGY)
        return <EnergyIcon color={color} size={size} />;
    if (name === ICON_NAMES.FILTER)
        return <FilterIcon color={color} size={size} />;
    if (name === ICON_NAMES.FITNESS)
        return <FitnessIcon color={color} size={size} />;
    if (name === ICON_NAMES.FOOD) return <FoodIcon color={color} size={size} />;
    if (name === ICON_NAMES.GROCERY)
        return <GroceryIcon color={color} size={size} />;
    if (name === ICON_NAMES.HEALT)
        return <HealtIcon color={color} size={size} />;
    if (name === ICON_NAMES.HOME) return <HomeIcon color={color} size={size} />;
    if (name === ICON_NAMES.LOGOUT)
        return <LogoutIcon color={color} size={size} />;
    if (name === ICON_NAMES.MORE) return <MoreIcon color={color} size={size} />;
    if (name === ICON_NAMES.PLANE)
        return <PlaneIcon color={color} size={size} />;
    if (name === ICON_NAMES.RECEIVEMONEY)
        return <ReceiveMoneyIcon color={color} size={size} />;
    if (name === ICON_NAMES.REFRESH)
        return <RefreshIcon color={color} size={size} />;
    if (name === ICON_NAMES.SENDMONEY)
        return <SendMoneyIcon color={color} size={size} />;
    if (name === ICON_NAMES.SETTINGS)
        return <SettingsIcon color={color} size={size} />;
    if (name === ICON_NAMES.TRANSFER)
        return <TransferIcon color={color} size={size} />;
    if (name === ICON_NAMES.USERPROFILE)
        return <UserProfileIcon color={color} size={size} />;
    if (name === ICON_NAMES.WATER)
